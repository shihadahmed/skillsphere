...
export default function HeroSlider() {
  ...
  return (
    <>
      ...
      <section className="hidden md:block relative max-w-[1256px] w-full h-[700px] mx-auto overflow-hidden md:rounded-3xl mt-4 border border-gray-200 bg-white shadow-xl transition-all duration-300">
        <Swiper
